...
export const metadata: Metadata = {
    title: "Trending Music | Music Hub",
    description: "Discover the hottest trending songs right now. Listen to the most popular tracks that everyone is playing.",
    openGraph: {
        title: "Trending Music | Music Hub",
        description: "Discover the hottest trending songs right now. Listen to the most popular tracks.",
        type: "website",
    },
    twitter: {
        card: "summary_large_image",
        title: "Trending Music | Music Hub",
        description: "Discover the hottest trending songs right now.",
    },
};
